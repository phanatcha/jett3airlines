...
const testFlights = [
  // BKK to BER Flights (Departure flights)
  // December 10, 2025 - Multiple options
  ...
  // December 15, 2025 - Multiple options
  ...
  // December 20, 2025 - Multiple options
  ...
  // BER to BKK Flights (Return flights)
  // December 13, 2025 - Multiple return options
  ...
  // December 18, 2025 - Multiple return options
  ...
  // December 23, 2025 - Multiple return options
  ...
  // December 25, 2025 - Christmas return flights
  ...
  // Add some flights with different statuses for testing
