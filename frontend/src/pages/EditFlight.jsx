  ...
  useEffect(() => {
    if (flightData) {
      ...
      setFormData({
        ...
        departureTime: formatDateTimeForInput(flightData.departureTime) || '',
        arrivalTime: formatDateTimeForInput(flightData.arrivalTime) || '',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="px-16 py-8 max-w-4xl mx-auto">
        <h2 className="text-black mb-8">Editing flight</h2>
        
        <div className="space-y-6">
          {/* Row 1: Flight Number and Airplane */}
          ...
          <div className="flex justify-end space-x-4 mt-8">
            <button
              ...
              className="px-8 py-3 rounded-lg text-lg font-semibold border-2 border-gray-300 text-black hover:bg-gray-50 transition-colors duration-200"
            >
              Cancel
            </button>
            <button
